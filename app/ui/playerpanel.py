...
class FavouriteFrame(QtWidgets.QFrame):
    def __init__(self, p):
        ...
        self.favouriteButton.clicked.connect(self.update_icon)
    ...
    def update_icon(self):
        ...
        if self.current_state!=True:
            self.favouriteButton.setIcon(QIcon("res/icons/fav-untoggled.svg"))
            self.favouriteButton.setIconSize(QSize(16, 16))
            self.favouriteButton.setToolTip("Favorite Untoggled")
        else:
            self.favouriteButton.setIcon(QIcon("res/icons/fav-toggled.svg"))
            self.favouriteButton.setIconSize(QSize(16, 16))
            self.favouriteButton.setToolTip("Favorite Toggled")
